...
filenames=['Reliance_score.csv','NSE_Reliance.csv']
...
for i1,r1 in df2.iterrows():
    #print(r1)
    temp=pd.DataFrame({'Date':[r1.Date],'Open':[r1.Open_Price],'Close':[r1.Close_Price], 'High':[r1.High_Price], 'Low':[r1.Low_Price]})
